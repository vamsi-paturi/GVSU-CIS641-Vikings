...
## Run Instructions
* Use the guide to Install and run the EMS Application [Click here to read the instructions](https://github.com/thotave/GVSU-CIS641-Vikings/tree/master/tests)
